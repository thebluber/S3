package Menu.ComboMenuScreens
{
  ...
  public class ComboSelect extends Screen
  {
    ...
    override protected function initialize():void {
      ...
      var time:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-leveluptime"));
      time.x = 40;
      time.y = 40;
      ...
      var chaintime:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-chaintime"));
      chaintime.x = time.x;
      ...
      var xtraspawn:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-xtraspawn"));
      xtraspawn.x = time.x;
      ...
      var shuffle:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-shuffle"));
      shuffle.x = time.x;
      ...
      var gold:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-gold"));
      gold.x = time.x;
      ...
      var xtralife:Button = new Button(AssetRegistry.Alpha_1_Atlas.getTexture("combo-xtralife"));
      xtralife.x = time.x;
